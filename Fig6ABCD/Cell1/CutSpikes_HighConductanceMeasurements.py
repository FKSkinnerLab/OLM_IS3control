...
def getMeasures(inhsyn,excsyn,inhspikes,excspikes,examplenum,repnum,modfreq,modfreqnum):	
	...
	h.f(int(inhsyn),int(excsyn),int(inhspikes),int(excspikes),0,example,rep,exccommon,inhcommon,30,0,modfreq,0) # Runs Simulation
